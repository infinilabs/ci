...
PNAME="${PNAME:-coco}"                                  # Product name (can be overridden by env var)
...
DEFAULT_APP_VERSION="0.5.3-2275"                       # Default application version for local reference
MAX_BACKUPS=3                                          # Number of recent backups to keep
DEFAULT_SERVICE_NAME=""               # Default: no specific service name to control
